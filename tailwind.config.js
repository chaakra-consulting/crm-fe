  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'secondary-gradient': 'linear-gradient(180deg, #309F92 0%, #0C5666 100%)',
        'success-gradient': 'linear-gradient(180deg, #2DCB73 0%, #0DA952 100%)',
        'info-gradient': 'linear-gradient(180deg, #4F84F4 0%, #320F84 100%)',
        ...
        'dark-gradient': 'linear-gradient(180deg, #4B749F 0%, #243748 100%)',
        'indigo-gradient': 'linear-gradient(180deg, #8351FD 0%, #5112A9 100%)',
