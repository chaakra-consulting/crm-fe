    ...
    <div class="w-full flex flex-wrap justify-between items-center gap-4">
      ...
      <div class="flex items-center gap-3">
        ...
        <a
          href="#sidebar"
          id="mobile_btn"
          class="block lg:hidden text-gray-600 dark:text-gray-300 mobile_btn"
      ...
      <div class="flex items-center gap-3">
        ...
        <div class="relative">
          ...
          >
            ...
            <span
              class="absolute top-[6px] right-[6px] bg-danger text-white font-normal w-[12px] h-[12px] text-[6px] p-0 flex items-center justify-center rounded-full"
              >10</span
            >
          </button>
          <div
          ...
          >
            ...
            <!-- Notification Body -->
            <div
              class="relative z-[2] rounded-none overflow-y-auto scroll-smooth h-[270px] max-h-[300px]"
            >
              <!-- Item -->
              ...
              <div class="py-4 border-b px-4 border-borderColor">
                <div class="flex">
                  ...
                  <div class="flex-1">
                    ...
                    <p class="mb-1">
                      mentioned you in
                      <span class="font-medium text-gray-900">Bug Fix Review - Task #432</span>
                    </p>
                    <div class="flex justify-between items-center text-xs text-gray-500">
            ...
            <div class="p-2 rounded-b border-t border-borderColor text-center">
              <router-link
                to="/notifications"
                class="text-center underline text-sm text-gray-900 hover:text-primary"
              >
        ...
        <div>
          ...
          >
            <span class="relative">
              <div v-if="user.photo != null">
                ...
                />
                <span
                  class="right-0 bottom-0 absolute w-3 h-3 bg-success border-2 border-white rounded-full"
                ></span>
              </div>
              <div v-else>
                <Avatar :name="user.name" bg-color="#9DEAFF" variant="rounded" />
              </div>
              <span
                class="right-0 bottom-0 absolute w-3 h-3 bg-success border-2 border-white rounded-full"
              ></span>
          ...
          <div
            id="profile-dropdown"
            class="z-10 hidden bg-white rounded-[5px] shadow w-[250px] p-2 pb-0"
          >
...
onMounted(() => {
  ...
  user.value.role_name = storedUser.role_name || '-'
