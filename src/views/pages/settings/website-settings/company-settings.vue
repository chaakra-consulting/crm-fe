        ...
        <div class="xl:col-span-9">
          <div class="bg-white border border-borderColor rounded p-4">
            <div class="border-b border-borderColor mb-3 pb-3">
              <h5 class="mb-0 text-[17px]">Company Settings</h5>
            </div>
            <form>
              <div class="mb-3">
              ...
              <div class="border-b border-borderColor pb-1 mb-4">
              ...
              <div class="border-b border-borderColor mb-4 pb-1">
                <div class="mb-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-y-1 gap-x-6">
                  ...
                  <div class="md:col-span-6">
                    <div class="mb-3">
                      ...
                      <vue3-select v-model="selected" :options="CountPro" placeholder="Select" />
                    </div>
                  </div> <!-- end col -->
                  ...
                  <div class="md:col-span-6">
                    <div class="mb-3">
                      ...
                      <vue3-select v-model="selectedOne" :options="StatPro" placeholder="Select" />
                    </div>
                  </div> <!-- end col -->
                  ...
                  <div class="md:col-span-6">
                    <div class="mb-3">
                      ...
                      <vue3-select v-model="selectedTwo" :options="CityPro" placeholder="Select" />
                    </div>
                  </div> <!-- end col -->
