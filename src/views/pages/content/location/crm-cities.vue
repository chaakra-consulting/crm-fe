<template>
        ...
        <div>
          ...
          <nav aria-label="breadcrumb">
            <ol class="flex flex-wrap space-x-1 text-sm text-gray-500">
              ...
              <li class="text-dark font-medium" aria-current="page">City</li>
            </ol>
          </nav>
        </div>
      ...
      <div class="card">
        ...
        <div class="bg-white p-4">
          ...
          <div class="table-responsive custom-table">
            <div id="cities_list_wrapper" class="dt-container dt-tailwindcss dt-empty-footer">
    ...
    <div class="relative p-4 w-full max-w-[500px] max-h-full">
      <div class="relative bg-white rounded-defaultradius">
        <div class="flex items-center justify-between p-4 border-b border-borderColor">
          <h5 class="font-bold text-[18px]">Add City</h5>
          <button type="button"
  ...
  <div id="edit_modal"
    ...
    <div class="relative p-4 w-full max-w-[500px] max-h-full">
      <div class="relative bg-white rounded-defaultradius">
        <div class="flex items-center justify-between p-4 border-b border-borderColor">
          <h5 class="font-bold text-[18px]">Edit City</h5>
          <button type="button"
            class="text-danger hover:text-danger text-sm w-6 h-6 border border-borderColor bg-danger-100 rounded-full absolute top-3 end-3 flex items-center justify-center"
        ...
        <form>
          <div class="p-4">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-y-4 gap-x-6">
              ...
              <div class="md:col-span-12">
                <label class="form-label">State Name <span class="text-danger">*</span></label>
                <input type="text" class="form-control" value="Indiana">
              </div>
              <div class="md:col-span-12">
                <label class="form-label">City Name <span class="text-danger">*</span></label>
                <input type="text" class="form-control" value="Indianapolis">
              </div>
            </div>
          </div>
          <div class="flex items-center justify-end p-4 border-t border-borderColor">
...
const columns = [
  ...
  },
  {
    ...
    key: "StateName",
    sorter: {
      compare: (a, b) => (a.StateName.toLowerCase() > b.StateName.toLowerCase() ? -1 : 1),
    },
  },
  {
    title: "City Name",
    ...
    key: "CityName",
    sorter: {
      compare: (a, b) => (a.CityName.toLowerCase() > b.CityName.toLowerCase() ? -1 : 1),
    },
  },
  {
    title: "Action",
    ...
    filteredPages() {
      ...
      return this.data.filter((record) => {
        return (
          ...
          record.StateName.toLowerCase().includes(query) ||
          record.CityName.toLowerCase().includes(query)
        );
      });
    },
    paginatedData() {
