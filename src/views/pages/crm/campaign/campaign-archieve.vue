      ...
      <ul class="flex flex-wrap gap-y-3 items-center border-b border-borderColor mb-7">
        <li>
          <router-link to="/crm/campaign"
            class="inline-block py-2 px-4 border-b-2  border-transparent  hover:text-primary font-medium">Active
        ...
        <li>
          <router-link to="/crm/campaign-archieve"
            class="inline-block py-2 px-4 border-b-2 border-primary text-primary font-medium hover:text-primary">Archived
            Campaign</router-link>
        </li>
      </ul>
      ...
      <div class="card">
        ...
        <div class="bg-white p-4">
          ...
          <div class="table-responsive custom-table">
            <div id="campaign-archieve_wrapper" class="dt-container dt-tailwindcss dt-empty-footer">
                  ...
                  <table
                    ...
                    <tbody>
                      ...
                      <tr class="even:bg-gray-50 dark:even:bg-gray-900/50">
                        ...
                        <td class="p-3"><span
                            class="px-1.5 py-1 rounded text-[12px] text-white bg-warning">Pending</span></td>
                        <td class="p-3">
