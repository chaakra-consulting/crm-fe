      ...
      <div class="card">
        ...
        <div class="bg-white p-4">
            ...
            <div class="flex items-center flex-wrap gap-y-3">
              ...
              <div class="me-3">
                <a href="javascript:void(0);"
                  ...
                  All Proposals<i class="ti ti-chevron-down ml-1"></i>
                </a>
                <ul id="proposal-dropdown"
                  ...
                  <li>
                    <a href="javascript:void(0);"
                      class="rounded p-2 flex items-center hover:bg-primary-transparent hover:text-primary text-gray-900">Accepted</a>
                  </li>
                  <li>
                    <a href="javascript:void(0);"
                      class="rounded p-2 flex items-center hover:bg-primary-transparent hover:text-primary text-gray-900">Declined</a>
                  </li>
                  <li>
                    <a href="javascript:void(0);"
                      class="rounded p-2 flex items-center hover:bg-primary-transparent hover:text-primary text-gray-900">Draft</a>
                  </li>
                  <li>
                    <a href="javascript:void(0);"
                      class="rounded p-2 flex items-center hover:bg-primary-transparent hover:text-primary text-gray-900">Deleted</a>
                  </li>
                </ul>
              </div>
              <!-- Dropdown -->
              ...
              <div class="me-3">
                ...
                <ul id="column-dropdown"
                  ...
                  <li class="flex items-center gap-2 mb-2 p-1">
                    ...
                    <label class="flex items-center justify-between w-full cursor-pointer">
                      <input type="checkbox" value="" class="sr-only peer">
                      <span class="text-sm font-medium">Open till</span>
                      <span
                        class="relative w-8 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-0 peer-focus:ring-primary rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] peer-checked:after:start-[-2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-primary"></span>
                    </label>
                  </li>
          ...
          <div class="table-responsive custom-table">
            <div id="proposals-list_wrapper" class="dt-container dt-tailwindcss dt-empty-footer">
                ...
                <div class="col-span-2 table-responsive">
                  <a-table
                    ...
                    <template #bodyCell="{ column, record }">
                      ...
                      <template v-if="column.key === 'ProposalsID'">
                        <a href="javascript:void(0);" class="title-name">{{ record.ProposalsID }}</a>
                      </template>
                      <template v-if="column.key === 'Subject'">
                        <a href="javascript:void(0);" class="title-name">{{ record.Subject }}</a>
                      </template>
                      <template v-if="column.key === 'SendTo'">
                        <h6 class="flex items-center font-medium text-[14px]">
                          <router-link :to="'/crm/company-details'"
                            class="w-10 h-10 border border-borderColor flex items-center justify-center rounded-full me-2">
                            <img class="w-auto h-auto" :src="getImageUrl(record.Image)" alt="Company Image">
                          </router-link>
                          <router-link :to="'/crm/company-details'" class="hover:text-primary">
                            {{ record.SendTo }}
                          </router-link>
                        </h6>
                      </template>
                      ...
                      <template v-if="column.key === 'Project'">
                        <h6 class="flex items-center font-medium text-[14px]">
                          <router-link to="/crm/project-details"
                            class="w-10 h-10 border border-borderColor flex items-center justify-center rounded-full me-2">
                            <img class="w-auto h-auto" :src="getImageUrlOne(record.ProjectImage)" alt="Project Image">
                          </router-link>
                          <router-link to="/crm/project-details" hover:text-primary="">
                            {{ record.Project }}
                          </router-link>
                        </h6>
                      </template>
                      ...
                      <template v-if="column.key === 'Status'">
                        <span class="px-1.5 py-0.5 rounded text-[12px] text-white inline-flex" :class="{
                          'bg-success': record.Status === 'Accepted',
                          'bg-warning': record.Status === 'Declined',
                          'bg-danger': record.Status === 'Deleted',
                          'bg-info': record.Status === 'Draft' || record.Status === 'Sent' || record.Status === 'Paused'
                        }">
                          {{ record.Status }}
                        </span>
                      </template>
                        ...
                        <div class="dropdown relative table-action">
                          ...
                          <div
                            ...
                            <a class="dropdown-item rounded p-2 flex items-center hover:bg-primary-transparent hover:text-primary text-gray-900"
                              ...
                              <i class="ti ti-clipboard-copy me-1"></i> View Proposal
                            </a>
                            <a class="dropdown-item rounded p-2 flex items-center hover:bg-primary-transparent hover:text-primary text-gray-900"
                              href="javascript:void(0);">
                              <i class="ti ti-checks me-1"></i> Mark as Accepted
                            </a>
                            <a class="dropdown-item rounded p-2 flex items-center hover:bg-primary-transparent hover:text-primary text-gray-900"
                              href="javascript:void(0);">
                              <i class="ti ti-file me-1"></i> Mark as Draft
                            </a>
                            <a class="dropdown-item rounded p-2 flex items-center hover:bg-primary-transparent hover:text-primary text-gray-900"
                              href="javascript:void(0);">
                              <i class="ti ti-sticker me-1"></i> Mark as Declined
                            </a>
                            <a class="dropdown-item rounded p-2 flex items-center hover:bg-primary-transparent hover:text-primary text-gray-900"
                              href="javascript:void(0);">
                              <i class="ti ti-subtask me-1"></i> Convert to estimate
                            </a>
                            <a class="dropdown-item rounded p-2 flex items-center hover:bg-primary-transparent hover:text-primary text-gray-900"
                              href="javascript:void(0);">
                              <i class="ti ti-file-invoice me-1"></i> Convert to Invoice
                            </a>
                            <a class="dropdown-item rounded p-2 flex items-center hover:bg-primary-transparent hover:text-primary text-gray-900"
                              href="javascript:void(0);">
...
const columns = [
  {
    ...
    sorter: {
      compare: (a, b) =>
        a.ProposalsID.toLowerCase() > b.ProposalsID.toLowerCase() ? -1 : 1,
    },
  },
  {
    title: "Subject",
  ...
  },
  {
    ...
    key: "SendTo",
    sorter: {
      compare: (a, b) => (a.SendTo.toLowerCase() > b.SendTo.toLowerCase() ? -1 : 1),
    },
  },
  {
    title: "Total Value",
    ...
    sorter: {
      compare: (a, b) =>
        a.TotalValue.toLowerCase() > b.TotalValue.toLowerCase() ? -1 : 1,
    },
  },
  {
    title: "Project",
    ...
    key: "Project",
    sorter: {
      compare: (a, b) => (a.Project.toLowerCase() > b.Project.toLowerCase() ? -1 : 1),
    },
  },
  {
    title: "Created Date",
  ...
  computed: {
    filteredPages() {
      ...
      return this.data.filter((record) => {
        return (
          record.ProposalsID.toLowerCase().includes(query) ||
          record.Subject.toLowerCase().includes(query) ||
          record.SendTo.toLowerCase().includes(query) ||
          record.TotalValue.toLowerCase().includes(query) ||
