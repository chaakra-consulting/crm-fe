<template>
  ...
  >
    <div class="p-4 border-b border-borderColor">
      <h5 class="inline-flex items-center font-bold">Edit Pertanyaan</h5>
...
export default {
  ...
  methods: {
    ...
    async updateData() {
      ...
      formData.append('order_number', this.survey.order_number)

      // POST ke backend
      api
        .post(`/survey-question/${this.survey.id}`, formData, {
          headers: {
