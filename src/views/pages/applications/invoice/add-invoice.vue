            ...
            <div class="grid grid-cols-12 gap-4">
              ...
              <div class="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-6 xl:col-span-6">
                <div>
                  ...
                  <vue3-select v-model="selected" :options="Customer" placeholder="Select Customer"></vue3-select>
                </div>
              </div>
              <div class="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-6 xl:col-span-6">
                <div>
                  <label class="form-label">Tax <span class="text-danger">*</span></label>
                  <vue3-select v-model="selectedOne" :options="Tax" placeholder="Select Tax"></vue3-select>
                </div>
              </div>
              <div class="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-6 xl:col-span-6">
              ...
              <div class="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-6 xl:col-span-6">
                <div>
                  ...
                  <vue3-select v-model="selectedTwo" :options="PaymentMethod" placeholder="Select Payment Method"></vue3-select>
                </div>
              </div>
              <div class="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-6 xl:col-span-6">
                <div>
                  <label class="form-label">Payment Status <span class="text-danger">*</span></label>
                  <vue3-select v-model="selectedThree" :options="PaymentStatus" placeholder="Select Payment Status"></vue3-select>
                </div>
              </div>
