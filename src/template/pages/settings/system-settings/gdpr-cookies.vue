    ...
    <div class="xl:col-span-9">
      <div class="bg-white border border-borderColor rounded p-4">
        <div class="border-b border-borderColor mb-3 pb-3">
          <h5 class="mb-0 text-[17px]">GDPR Cookies</h5>
        </div>
        <form>
          <div class="border-b border-borderColor pb-2 mb-4">
            <div class="grid grid-cols-1 xl:grid-cols-12 gap-y-1 gap-x-4 items-center">
              <div class="md:col-span-6">
                <div class="mb-3">
                  <h6 class="text-[14px] font-semibold mb-1">Cookies Content Text</h6>
                  <p class="text-[13px]">You can configure the text here</p>
                </div>
              </div>
              <div class="md:col-span-6">
                <div class="mb-3">
                    <div class="editor three-line ql-container ql-snow">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-12 gap-y-1 gap-x-4 items-center">
              <div class="md:col-span-8">
                <div class="mb-3">
                  <h6 class="text-[14px] font-semibold mb-1">Cookies Position</h6>
                  <p class="text-[13px]">You can configure the type</p>
                </div>
              </div>
            ...
            <div class="grid grid-cols-1 xl:grid-cols-12 gap-y-1 gap-x-4 items-center">
              <div class="md:col-span-8">
                <div class="mb-3">
                  <h6 class="text-[14px] font-semibold mb-1">Agree Button Text</h6>
                  <p class="text-[13px]">You can configure the text here</p>
                </div>
              </div>
              <div class="md:col-span-4">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-12 gap-y-1 gap-x-4 items-center">
              <div class="md:col-span-8">
                <div class="mb-3">
                  <h6 class="text-[14px] font-semibold mb-1">Decline Button Text</h6>
                  <p class="text-[13px]">You can configure the text here</p>
                </div>
              </div>
              <div class="md:col-span-4">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-12 gap-y-1 gap-x-4 items-center">
              <div class="md:col-span-8">
                <div class="mb-3">
                  <h6 class="text-[14px] font-semibold mb-1">Show Decline Button</h6>
                  <p class="text-[13px]">To display decline button</p>
                </div>
              </div>
              <div class="md:col-span-4">
                <div class="mb-3">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-12 gap-y-1 gap-x-4 items-center">
              <div class="md:col-span-8">
                <div class="mb-3">
                  <h6 class="text-[14px] font-semibold mb-1">Link for Cookies Page</h6>
                  <p class="text-[13px]">You can configure the link here</p>
                </div>
              </div>
              <div class="md:col-span-4">
                <div class="mb-3">
