<template>
        ...
        <div class="xl:col-span-9">
          <div class="bg-white border border-borderColor rounded p-4">
            <div class="border-b border-borderColor flex items-center justify-between mb-3 pb-3">
              <h5 class="mb-0 text-[17px]">Ban IP Address</h5>
            ...
            <div class="table-responsive custom-table">
              <table class="table table-nowrap w-full">
                <thead class="table-light">
                  <tr>
                    <th class="p-3 text-dark text-left">Ban Ip Address</th>
                    <th class="p-3 text-dark text-left">Reason</th>
                ...
                <tbody>
                  <tr>
                    <td class="p-3">211.11.0.25</td>
                    <td class="p-3">Suspicious Activity</td>
                  ...
                  <tr>
                    <td class="p-3">211.03.0.11</td>
                    <td class="p-3">Spam or Abuse</td>
                    <td class="p-3">10 Feb 2025</td>
                    <td class="p-3">
                  ...
                  <tr>
                    <td class="p-3">211.24.0.17</td>
                    <td class="p-3">Unauthorized Access</td>
                  ...
                  <tr>
                    <td class="p-3">211.12.0.34</td>
                    <td class="p-3">Violation of Terms</td>
    ...
    <div class="relative p-4 w-full max-w-[500px] max-h-full">
      <div class="relative bg-white rounded-defaultradius">
        <div class="flex items-center justify-between p-4 border-b border-borderColor">
          <h5 class="font-bold text-[18px]">Add Ban IP Address</h5>
          <button type="button"
  ...
  <div id="edit_modal"
    ...
    <div class="relative p-4 w-full max-w-[500px] max-h-full">
      <div class="relative bg-white rounded-defaultradius">
        <div class="flex items-center justify-between p-4 border-b border-borderColor">
          <h5 class="font-bold text-[18px]">Edit Ban IP Address</h5>
          <button type="button"
            class="text-danger hover:text-danger text-sm w-6 h-6 border border-borderColor bg-danger-100 rounded-full absolute top-3 end-3 flex items-center justify-center"
        ...
        <form>
          <div class="p-4">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-y-4 gap-x-4">
              ...
              <div class="md:col-span-12">
                <label class="form-label">Reason <span class="text-danger">*</span></label>
                <textarea class="form-control" rows="4">Suspicious Activity	</textarea>
              </div>
            </div>
          </div>
          <div class="flex items-center justify-end p-4 border-t border-borderColor">
    ...
    <div class="relative bg-white rounded-defaultradius p-5">
      <div class="modal-content rounded-0">
        <div class="modal-body p-4 text-center">
          ...
          <p class="mb-3">Are you sure you want to remove ban ip you selected.</p>
