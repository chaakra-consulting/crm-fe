        ...
        <div>
          ...
          <nav aria-label="breadcrumb">
            <ol class="flex flex-wrap space-x-1 text-sm text-gray-500">
              ...
              <li class="text-dark font-medium" aria-current="page">Contact Messages</li>
            </ol>
          </nav>
        </div>
      ...
      <div class="card">
        <div
          ...
          <a href="javascript:void(0);"
            ...
            data-modal-target="add_contact" data-modal-toggle="add_contact">
        ...
        <div class="bg-white p-4">
          ...
          <div class="table-responsive custom-table">
            <div id="contact-messages-list_wrapper" class="dt-container dt-tailwindcss dt-empty-footer">
                    ...
                    <template #bodyCell="{ column, record }">
                      <template v-if="column.key === 'Name'">
                        <h6 class="flex items-center text-[14px] font-medium mb-0">
                          ...
                          <router-link to="/crm/contact-details" class="flex flex-col text-gray-900 hover:text-primary">
                            {{ record.Name }}
                      ...
                      <template v-if="column.key === 'Status'">
                        <span :class="record.Status === 'Active' ? 'bg-success' : 'bg-danger'" class="badge">
                          {{ record.Status }}
                        </span>
                      </template>
                        ...
                        <div class="dropdown relative table-action">
                          ...
                          <div
                            ...
                            <a class="dropdown-item rounded p-2 flex items-center hover:bg-primary-transparent hover:text-primary text-gray-900"
                              href="javascript:void(0);" data-modal-target="edit_contact"
                              data-modal-toggle="edit_contact">
