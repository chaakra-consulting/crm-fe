<template>
        ...
        <div>
          ...
          <nav aria-label="breadcrumb">
            <ol class="flex flex-wrap space-x-1 text-sm text-gray-500">
              ...
              <li class="text-dark font-medium" aria-current="page">States</li>
            </ol>
          </nav>
        </div>
      ...
      <div class="card">
        ...
        <div class="bg-white p-4">
          ...
          <div class="table-responsive custom-table">
            <div id="states_list_wrapper" class="dt-container dt-tailwindcss dt-empty-footer">
                    ...
                    <template #bodyCell="{ column, record }">
                      ...
                      <template v-if="column.key === 'CountryName'">
                        <a href="javascript:void(0);" class="flex items-center">
                          <span class="me-2"><img :src="getImageUrl(record.Image)" class="img-fluid" alt="img"></span>
    ...
    <div class="relative p-4 w-full max-w-[500px] max-h-full">
      <div class="relative bg-white rounded-defaultradius">
        <div class="flex items-center justify-between p-4 border-b border-borderColor">
          <h5 class="font-bold text-[18px]">Add State</h5>
          <button type="button"
  ...
  <div id="edit_modal"
    ...
    <div class="relative p-4 w-full max-w-[500px] max-h-full">
      <div class="relative bg-white rounded-defaultradius">
        <div class="flex items-center justify-between p-4 border-b border-borderColor">
          <h5 class="font-bold text-[18px]">Edit State</h5>
          <button type="button"
            class="text-danger hover:text-danger text-sm w-6 h-6 border border-borderColor bg-danger-100 rounded-full absolute top-3 end-3 flex items-center justify-center"
    ...
    <div class="relative bg-white rounded-defaultradius p-5">
      <div class="modal-content rounded-0">
        <div class="modal-body p-4 text-center">
          ...
          <p class="mb-3">Are you sure you want to remove state you selected.</p>
