    ...
    <div class="content p-5">
      <div class="flex justify-center">
        <div class="w-full lg:w-10/12 mx-auto">
          <div class="bg-white">
            <div class="p-4 border-b border-borderColor flex items-center justify-between gap-2 flex-wrap">
              <h6 class="fs-18 mb-0">Edit Page</h6>
              <router-link to="/content/pages" class="btn btn-primary btn-sm">Back<i class="ti ti-chevron-right ms-1"></i></router-link>
            </div>
            <form>
              <div class="p-4 pb-2">
                <div class="grid grid-cols-1 md:grid-cols-12 gap-x-5">
                  <div class="md:col-span-12">
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" value="Reports">
                    </div>
                  </div>
                  <div class="md:col-span-12">
                    <div class="mb-3">
                  ...
                  <div class="md:col-span-12">
                    <div class="mb-3">
                      ...
                      <textarea class="form-control"
                        rows="3"> Track revenue targets, closed deals, deal velocity, and quota attainment by team or individual sales reps.</textarea>
                    </div>
                  </div>
                </div>
              </div>
