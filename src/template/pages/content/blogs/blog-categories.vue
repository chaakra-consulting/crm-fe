<template>
        ...
        <div>
          ...
          <nav aria-label="breadcrumb">
            <ol class="flex flex-wrap space-x-1 text-sm text-gray-500">
              ...
              <li class="text-dark font-medium" aria-current="page">Blog Categories</li>
            </ol>
          </nav>
        </div>
      ...
      <div class="card">
        ...
        <div class="bg-white p-4">
          ...
          <div class="table-responsive custom-table">
            <div id="categories_list_wrapper" class="dt-container dt-tailwindcss dt-empty-footer">
                  ...
                  <table
                      ...
                      <tr class="border-b border-gray-100 dark:border-gray-700/50">
                       ...
                       : Activate to invert sorting" tabindex="0"><span class="dt-column-title" role="button">
                        ...
                        <th data-dt-column="1"
                          ...
                          rowspan="1" colspan="1" aria-label="Category Name: Activate to sort" tabindex="0"><span
                            class="dt-column-title text-gray-900" role="button">Category Name</span><span
                        ...
                        <th
                          ...
                          data-dt-column="4" rowspan="1" colspan="1" aria-label="Action: Activate to sort" tabindex="0">
                    ...
                    <tbody>
                      <tr class="even:bg-gray-50 dark:even:bg-gray-900/50">
                        ...
                        <td class="p-3"><span class="title-name">Sales Optimization</span></td>
                      ...
                      <tr class="even:bg-gray-50 dark:even:bg-gray-900/50">
                        ...
                        <td class="p-3"><span class="title-name">Automation</span></td>
                      ...
                      <tr class="even:bg-gray-50 dark:even:bg-gray-900/50">
                        ...
                        <td class="p-3"><span class="title-name">Marketing</span></td>
                      ...
                      <tr class="even:bg-gray-50 dark:even:bg-gray-900/50">
                        ...
                        <td class="p-3"><span class="title-name">Implementation</span></td>
                      ...
                      <tr class="even:bg-gray-50 dark:even:bg-gray-900/50">
                        ...
                        <td class="p-3"><span class="title-name">Product Features</span></td>
                      ...
                      <tr class="even:bg-gray-50 dark:even:bg-gray-900/50">
                        ...
                        <td class="p-3"><span class="title-name">Data &amp; Analytics</span></td>
                      ...
                      <tr class="even:bg-gray-50 dark:even:bg-gray-900/50">
                        ...
                        <td class="p-3"><span class="title-name">Customization</span></td>
                      ...
                      <tr class="even:bg-gray-50 dark:even:bg-gray-900/50">
                        ...
                        <td class="p-3"><span class="title-name">Future &amp; Trends</span></td>
                      ...
                      <tr class="even:bg-gray-50 dark:even:bg-gray-900/50">
                        ...
                        <td class="p-3"><span class="title-name">Training &amp; Adoption</span></td>
                      ...
                      <tr class="even:bg-gray-50 dark:even:bg-gray-900/50">
                        ...
                        <td class="p-3"><span class="title-name">Security</span></td>
    ...
    <div class="relative p-4 w-full max-w-[500px] max-h-full">
      <div class="relative bg-white rounded-defaultradius">
        <div class="flex items-center justify-between p-4 border-b border-borderColor">
          <h5 class="font-bold text-[18px]">Add Blog Category</h5>
          <button type="button"
  ...
  <div id="edit_modal"
    ...
    <div class="relative p-4 w-full max-w-[500px] max-h-full">
      <div class="relative bg-white rounded-defaultradius">
        <div class="flex items-center justify-between p-4 border-b border-borderColor">
          <h5 class="font-bold text-[18px]">Edit Blog Category</h5>
          <button type="button"
            class="text-danger hover:text-danger text-sm w-6 h-6 border border-borderColor bg-danger-100 rounded-full absolute top-3 end-3 flex items-center justify-center"
    ...
    <div class="relative bg-white rounded-defaultradius p-5">
      <div class="modal-content rounded-0">
        <div class="modal-body p-4 text-center">
          ...
          <p class="mb-3">Are you sure you want to remove blog category you selected.</p>
