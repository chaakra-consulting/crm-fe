<template>
  ...
  <div id="offcanvas_add"
    ...
    <div class="p-4 border-b border-borderColor">
      <h5 class="inline-flex items-center">Add New Company</h5>
    ...
    <form>
      <div id="accordion-collapse-2" class="p-4" data-accordion="collapse">
        <div class="accordion-item border border-borderColor rounded mb-3">
          <h2 class="accordion-header" id="heading-4">
            <button
              ...
              type="button" data-accordion-target="#collapse-4" aria-expanded="false" aria-controls="collapse-4">
              <span class="flex items-center"><span class="w-8 h-8 rounded flex items-center justify-center me-1"><i
                    class="ti ti-user-plus"></i></span>Basic Info</span>
              <span><i class="ti ti-chevron-down"></i></span>
            </button>
          </h2>
          <div id="collapse-4" class="hidden p-4 border-t border-borderColor " aria-labelledby="heading-4">
              ...
              <div class="grid grid-cols-1 md:grid-cols-12 gap-x-5">
                ...
                <div class="md:col-span-6">
                  <div class="mb-3">
                    <div class="flex items-center justify-between">
                      ...
                      <a href="javascript:void(0);" class="label-add text-primary mb-1"
                        data-drawer-target="offcanvas_add2" data-drawer-show="offcanvas_add2"
                        aria-controls="offcanvas_add2" data-drawer-placement="right"><i class="ti ti-plus me-1"></i>Add
                        New</a>
                    </div>
                    <input type="text" class="form-control">
                  </div>
                ...
                <div class="md:col-span-6">
                  <div class="mb-3">
                    ...
                    <vue3-select v-model="selected" :options="Owner" placeholder="Select" />
                  </div>
                </div>
                <div class="md:col-span-6">
                  <div class="mb-3">
                    <label class="form-label">Tags </label>
                    <vue3-tags-input class="input-tags form-control" placeholder="" type="text" data-role="tagsinput"
                      name="Label" value="Tag1" :tags="tags2" />
                ...
                <div class="md:col-span-6">
                  <div class="mb-3">
                    ...
                    <vue3-select v-model="selectedOne" :options="Deals" placeholder="Select" />
                  </div>
                </div>
                <div class="md:col-span-6">
                  <div class="mb-3">
                    <label class="form-label">Source <span class="text-danger">*</span></label>
                    <vue3-select v-model="selectedTwo" :options="Source" placeholder="Select" />
                  </div>
                </div>
                <div class="md:col-span-6">
                  <div class="mb-3">
                    <label class="form-label">Industry <span class="text-danger">*</span></label>
                    <vue3-select v-model="selectedThree" :options="Industry" placeholder="Select" />
                  </div>
                </div>
                <div class="md:col-span-12">
                  <div class="mb-3">
                    <label class="form-label">Contacts <span class="text-danger">*</span></label>
                    <vue3-select v-model="selectedFour" :options="Contacts" placeholder="Select" />
                  </div>
                </div>
                <div class="md:col-span-6">
                  <div class="mb-3">
                    <label class="form-label">Currency <span class="text-danger">*</span></label>
                    <vue3-select v-model="selectedFive" :options="Currency" placeholder="Select" />
                  </div>
                </div>
                <div class="md:col-span-6">
                  <div class="mb-3">
                    <label class="form-label">Language <span class="text-danger">*</span></label>
                    <vue3-select v-model="selectedSix" :options="Language" placeholder="Select" />
                  </div>
                </div>
                <div class="md:col-span-12">
                  <div class="mb-0">
        ...
        <div class="accordion-item border border-borderColor rounded mb-3">
          <h2 class="accordion-header" id="heading-7">
            <button
              class="flex justify-between items-center w-full p-4 bg-white text-start text-dark font-bold text-[16px]"
              type="button" data-accordion-target="#collapse-7" aria-expanded="false" aria-controls="collapse-7">
              <span class="flex items-center"><span class="w-8 h-8 rounded flex items-center justify-center me-1"><i
                    class="ti ti-map-pin-cog"></i></span>Address Info</span>
              <span><i class="ti ti-chevron-down"></i></span>
            </button>
          </h2>
          <div id="collapse-7" class="hidden p-4  border-t border-borderColor" aria-labelledby="heading-7">
            <div class="accordion-body text-[12px]">
              <div class="grid grid-cols-1 md:grid-cols-12 gap-x-5">
                <div class="md:col-span-12">
                  <div class="mb-3">
                ...
                <div class="md:col-span-6">
                  <div class="mb-3">
                    ...
                    <vue3-select v-model="selectedSeven" :options="Country" placeholder="Select" />
                  </div>
                </div>
                <div class="md:col-span-6">
                  <div class="mb-3">
                    <label class="form-label">State / Province </label>
                    <vue3-select v-model="selectedEight" :options="State" placeholder="Select" />
                  </div>
                </div>
                <div class="md:col-span-6">
                  <div class="mb-3 mb-md-0">
                    <label class="form-label">City </label>
                    <vue3-select v-model="selectedNine" :options="City" placeholder="Select" />
                  </div>
                </div>
                <div class="md:col-span-6">
                  <div class="mb-0">
        ...
        <div class="accordion-item border border-borderColor rounded mb-3">
          <h2 class="accordion-header" id="heading-5">
            <button
              class="flex justify-between items-center w-full p-4 bg-white text-start text-dark font-bold text-[16px]"
              type="button" data-accordion-target="#collapse-5" aria-expanded="false" aria-controls="collapse-5">
              <span class="flex items-center"><span class="w-8 h-8 rounded flex items-center justify-center me-1"><i
                    class="ti ti-social"></i></span>Social Profile</span>
              <span><i class="ti ti-chevron-down"></i></span>
            </button>
          </h2>
          <div id="collapse-5" class="hidden p-4  border-t border-borderColor" aria-labelledby="heading-5">
            <div class="accordion-body text-[12px]">
              <div class="grid grid-cols-1 md:grid-cols-12 gap-x-5">
                <div class="md:col-span-6">
                  <div class="mb-3">
        ...
        <div class="accordion-item border border-borderColor rounded">
          <h2 class="accordion-header" id="heading-6">
            <button
              class="flex justify-between items-center w-full p-4 bg-white  text-start text-dark font-bold text-[16px]"
              type="button" data-accordion-target="#collapse-6" aria-expanded="false" aria-controls="collapse-6">
              <span class="flex items-center"><span class="w-8 h-8 rounded flex items-center justify-center me-1"><i
                    class="ti ti-accessible"></i></span>Access</span>
              <span><i class="ti ti-chevron-down"></i></span>
            </button>
          </h2>
          <div id="collapse-6" class="hidden p-4  border-t border-borderColor" aria-labelledby="heading-6">
            <div class="accordion-body text-[12px]">
  ...
  <div id="offcanvas_edit"
    ...
    tabindex="-1">
    <div class="p-4 border-b border-borderColor">
      <h5 class="inline-flex items-center">Edit Company</h5>
      ...
      <div id="accordion-collapse" class="p-4" data-accordion="collapse">
        <div class="accordion-item border border-borderColor rounded mb-3">
          <h2 class="accordion-header" id="heading-14">
            <button
              class="flex justify-between items-center w-full p-4 bg-white text-start text-dark font-bold text-[16px]"
              type="button" data-accordion-target="#collapse-14" aria-expanded="false" aria-controls="collapse-14">
              <span class="flex items-center"><span class="w-8 h-8 rounded flex items-center justify-center me-1"><i
                    class="ti ti-user-plus"></i></span>Basic Info</span>
              <span><i class="ti ti-chevron-down"></i></span>
            </button>
          </h2>
          <div id="collapse-14" class="hidden p-4 border-t border-borderColor " aria-labelledby="heading-14">
            <div class="accordion-body text-[12px]">
              <div class="grid grid-cols-1 md:grid-cols-12 gap-x-5">
                <div class="md:col-span-12">
                  <div class="flex items-center mb-3">
                ...
                <div class="md:col-span-6">
                  <div class="mb-3">
                    <label class="form-label">Phone 1</label>
                    <input type="text" class="form-control phone" name="phone" value="+1 989757485">
                  </div>
                </div>
                <div class="md:col-span-6">
                  <div class="mb-3">
                ...
                <div class="md:col-span-6">
                  <div class="mb-3">
                    <label class="form-label">Owner</label>
                    <vue3-select v-model="selectedTen" :options="Owner" placeholder="Hendry Milner" />
                  </div>
                </div>
                <div class="md:col-span-6">
                  <div class="mb-3">
                ...
                <div class="md:col-span-6">
                  <div class="mb-3">
                    ...
                    <vue3-select v-model="selectedEleven" :options="Deals" placeholder="Collins" />
                  </div>
                </div>
                <div class="md:col-span-6">
                  <div class="mb-3">
                    <label class="form-label">Source <span class="text-danger">*</span></label>
                    <vue3-select v-model="selectedTwele" :options="Source" placeholder="Phone Calls" />
                  </div>
                </div>
                <div class="md:col-span-6">
                  <div class="mb-3">
                    <label class="form-label">Industry <span class="text-danger">*</span></label>
                    <vue3-select v-model="selectedThirteen" :options="Industry" placeholder="Retail Industry" />
                  </div>
                </div>
                <div class="md:col-span-12">
                  <div class="mb-3">
                    <label class="form-label">Contacts <span class="text-danger">*</span></label>
                    <vue3-select v-model="selectedFourteen" :options="Contacts" placeholder="Darlee Robertson" />
                  </div>
                </div>
                <div class="md:col-span-6">
                  <div class="mb-3">
                    <label class="form-label">Currency <span class="text-danger">*</span></label>
                    <vue3-select v-model="selectedOnes" :options="Currency" placeholder="Dollar" />
                  </div>
                </div>
                <div class="md:col-span-6">
                  <div class="mb-3">
                    <label class="form-label">Language <span class="text-danger">*</span></label>
                    <vue3-select v-model="selectedTwos" :options="Language" placeholder="English" />
                  </div>
                </div>
                <div class="md:col-span-12">
                  <div class="mb-0">
            ...
            <div class="accordion-body text-[12px]">
              <div class="grid grid-cols-1 md:grid-cols-12 gap-x-5">
                ...
                <div class="md:col-span-6">
                  <div class="mb-3">
                    <label class="form-label">Country</label>
                    <vue3-select v-model="selectedThrees" :options="Country" placeholder="USA" />
                  </div>
                </div>
                <div class="md:col-span-6">
                  <div class="mb-3">
                    <label class="form-label">State / Province </label>
                    <vue3-select v-model="selectedFours" :options="State" placeholder="California" />
                  </div>
                </div>
                <div class="md:col-span-6">
                  <div class="mb-3 mb-md-0">
                    <label class="form-label">City </label>
                    <vue3-select v-model="selectedFives" :options="City" placeholder="Los Angeles" />
                  </div>
                </div>
                <div class="md:col-span-6">
                  <div class="mb-0">
        ...
        <div class="accordion-item border border-borderColor rounded mb-3">
          <h2 class="accordion-header" id="heading-15">
            <button
              class="flex justify-between items-center w-full p-4 bg-white text-start text-dark font-bold text-[16px]"
              type="button" data-accordion-target="#collapse-15" aria-expanded="false" aria-controls="collapse-15">
              <span class="flex items-center"><span class="w-8 h-8 rounded flex items-center justify-center me-1"><i
                    class="ti ti-social"></i></span>Social Profile</span>
              <span><i class="ti ti-chevron-down"></i></span>
            </button>
          </h2>
          <div id="collapse-15" class="hidden p-4  border-t border-borderColor" aria-labelledby="heading-15">
            <div class="accordion-body text-[12px]">
              <div class="grid grid-cols-1 md:grid-cols-12 gap-x-5">
                <div class="md:col-span-6">
                  <div class="mb-3">
        ...
        <div class="accordion-item border border-borderColor rounded">
          <h2 class="accordion-header" id="heading-16">
            <button
              class="flex justify-between items-center w-full p-4 bg-white  text-start text-dark font-bold text-[16px]"
              type="button" data-accordion-target="#collapse-16" aria-expanded="false" aria-controls="collapse-16">
              <span class="flex items-center"><span class="w-8 h-8 rounded flex items-center justify-center me-1"><i
                    class="ti ti-accessible"></i></span>Access</span>
              <span><i class="ti ti-chevron-down"></i></span>
            </button>
          </h2>
          <div id="collapse-16" class="hidden p-4  border-t border-borderColor" aria-labelledby="heading-16">
            <div class="accordion-body text-[12px]">
              <div class="flex items-center gap-4">
                <div class="form-check">
                  <input class="text-primary border-borderColor" type="radio" name="flexRadioDefault"
  ...
  <!-- Add Deals -->
  <div id="offcanvas_add2"
    class="offcanvas-popup fixed top-0 right-0 z-[9999] w-[800px] h-screen overflow-y-auto transition-transform translate-x-full bg-white"
    tabindex="-1">
    <div class="p-4 border-b border-borderColor">
      <h5 class="inline-flex items-center">Add New Deals</h5>
      <button type="button" data-drawer-hide="offcanvas_add2" aria-controls="offcanvas_add2"
        class="text-title bg-transparent hover:text-danger text-sm w-6 h-6 border border-borderColor bg-danger-100 rounded-full absolute top-3 end-3 flex items-center justify-center"><i
          class="ti ti-x"></i> <span class="sr-only">Close menu</span>
      </button>
    </div>
    <div class="p-4">
      <form>
        <div class="grid grid-cols-1 md:grid-cols-12 gap-x-5">
          ...
          <div class="md:col-span-6">
            <div class="mb-3">
              ...
              <vue3-select v-model="selectedSixs" :options="Pipeine" placeholder="Select" />
            </div>
          </div>
          <div class="md:col-span-6">
            <div class="mb-3">
              <label class="form-label">Status <span class="text-danger">*</span></label>
              <vue3-select v-model="selectedSevens" :options="Pipeine" placeholder="Select" />
            </div>
          </div>
          <div class="md:col-span-6">
            <div class="mb-3">
          ...
          <div class="md:col-span-6">
            <div class="mb-3">
              <label class="form-label">Currency <span class="text-danger">*</span></label>
              <vue3-select v-model="selectedEights" :options="Currency" placeholder="Select" />
            </div>
          </div>
          <div class="md:col-span-6">
            <div class="mb-3">
              <label class="form-label">Period <span class="text-danger">*</span></label>
              <vue3-select v-model="selectedNines" :options="Period" placeholder="Select" />
            </div>
          </div>
          <div class="md:col-span-6">
            <div class="mb-3">
          ...
          <div class="md:col-span-12">
            <div class="mb-3">
              <label class="form-label">Contacts <span class="text-danger">*</span></label>
              <vue3-select v-model="selectedTens" :options="Contacts" placeholder="Darlee Robertson" />
            </div>
            <div class="mb-3">
          ...
          <div class="md:col-span-6">
            <div class="mb-3">
              ...
              <div class="input-group w-auto input-group-flat">
                <a-date-picker v-model:value="valueOne" class="form-control" placeholder="dd/mm/yyyy" />
                <span class="input-group-text">
                  <i class="ti ti-calendar"></i>
                </span>
              </div>
          ...
          <div class="md:col-span-12">
            <div class="mb-3">
              ...
              <vue3-select v-model="selectedElevens" :options="Contacts" placeholder="Sharon Roy" />
            </div>
          </div>
          <div class="md:col-span-6">
            <div class="mb-3">
              ...
              <div class="input-group w-auto input-group-flat">
                <a-date-picker v-model:value="valueTwo" class="form-control" placeholder="dd/mm/yyyy" />
                <span class="input-group-text">
                  <i class="ti ti-calendar"></i>
                </span>
              </div>
          ...
          <div class="md:col-span-6">
            <div class="mb-3">
              <label class="form-label">Source <span class="text-danger">*</span></label>
              <vue3-select v-model="selectedTweles" :options="SourceOne" placeholder="Select" />
            </div>
          </div>
          <div class="md:col-span-6">
            <div class="mb-3">
          ...
          <div class="md:col-span-6">
            <div class="mb-3">
              ...
              <vue3-select v-model="selectedThirteens" :options="Priority" placeholder="Select" />
            </div>
          </div>
          <div class="md:col-span-12">
            <div class="mb-3">
        ...
        <div class="flex items-center justify-end">
          <button type="button" data-drawer-hide="offcanvas_add2" class="btn btn-light me-2">Cancel</button>
          <button type="submit" class="btn btn-primary">Save Changes</button>
        </div>
      </form>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      selectedTwele: [],
      selectedThirteen: [],
      selectedFourteen: "Darlee Robertson",
      selectedOnes: [],
      selectedTwos: [],
      selectedThrees: [],
      selectedFours: [],
      ...
      selectedEights: [],
      selectedNines: [],
      selectedTens: "Darlee Robertson",
      selectedElevens: "Sharon Roy",
      selectedTweles: [],
      selectedThirteens: [],
      Owner: [
