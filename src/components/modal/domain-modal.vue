      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button
            ...
            aria-label="Close"
          >
            <i data-bs-dismiss="modal" class="ti ti-x"></i>
          </button>
        </div>
        <form>
            ...
            <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="d-flex align-items-center file-name-icon">
                          ...
                          <div class="ms-2">
                            <h6 class="fw-medium fs-14"><a href="javascript:void(0);">NovaWave LLC</a></h6>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div class="col-md-4">
                <div class="mb-3">
                  ...
                  <h6 class="fw-normal">nw.example.com</h6>
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
      ...
      <div class="modal-content">
        <div class="modal-body">
          <div class="text-center">
            ...
            <h4 class="mb-2">Remove Domain?</h4>
            <p class="mb-0">
