                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="mb-3">
                      ...
                      <vue-select :options="DarSel" id="darsel" placeholder="Choose" />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-3">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      >
                      <vue-select :options="LanSel" id="Choose" placeholder="Choose" />
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="mb-0">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3 mb-md-0">
                      ...
                      <vue-select :options="CounSel" id="counsel" placeholder="Choose" />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="mb-0">
            ...
            <div class="pipeline-listing">
              <div class="pipeline-item">
                ...
                <div class="action-pipeline">
                  <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit_stage"
                    ><i class="ti ti-edit text-blue"></i>Edit</a
                  >
                  <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete_stage"
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                >
                <vue-select :options="SelectBrad" id="selectbrad" placeholder="Select" />
              </div>
            </div>
            <div class="col-md-6">
              <div class="mb-3">
            ...
            <div class="col-md-12">
              ...
              <div class="mb-3">
                ...
                <vue-select :options="SelectAdms" id="selectadms" placeholder="Select" />
              </div>
              <div class="mb-3">
                <div class="d-flex align-items-center justify-content-between">
                  <label class="col-form-label">Contacts</label>
              ...
              <div class="mb-3">
                ...
                <vue-select :options="SelectComp" id="selectcomp" placeholder="Select" />
              </div>
            </div>
          </div>
        </div>
                ...
                <li class="select-people-checkbox">
                  <label class="checkboxs">
                    ...
                    <span class="people-profile">
                      <a href="javascript:void(0);">Collins</a>
                    </span>
                  </label>
                </li>
                <li class="select-people-checkbox">
                  <label class="checkboxs">
                    ...
                    <span class="checkmarks"></span>
                    <span class="people-profile">
                      <a href="javascript:void(0);">Konopelski</a>
                    </span>
                  </label>
                </li>
                <li class="select-people-checkbox">
                  <label class="checkboxs">
                    ...
                    <span class="checkmarks"></span>
                    <span class="people-profile">
                      <a href="javascript:void(0);">Adams</a>
                    </span>
                  </label>
                </li>
                <li class="select-people-checkbox">
                  <label class="checkboxs">
                    ...
                    <span class="checkmarks"></span>
                    <span class="people-profile">
                      <a href="javascript:void(0);">Schumm</a>
                    </span>
                  </label>
                </li>
                <li class="select-people-checkbox">
                  <label class="checkboxs">
                    ...
                    <span class="checkmarks"></span>
                    <span class="people-profile">
                      <a href="javascript:void(0);">Wisozk</a>
                    </span>
                  </label>
                </li>
                <li class="select-people-checkbox">
                ...
                <li class="select-people-checkbox">
                  <label class="checkboxs">
                    ...
                    <span class="people-profile">
                      ...
                      <a href="javascript:void(0);">NovaWave LLC</a>
                    </span>
                  </label>
                </li>
                <li class="select-people-checkbox">
                  <label class="checkboxs">
                    ...
                    <span class="people-profile">
                      ...
                      <a href="javascript:void(0);">BlueSky Industries</a>
                    </span>
                  </label>
                </li>
                <li class="select-people-checkbox">
                  <label class="checkboxs">
                    ...
                    <span class="people-profile">
                      ...
                      <a href="javascript:void(0);">Silver Hawk</a>
                    </span>
                  </label>
                </li>
                <li class="select-people-checkbox">
                  <label class="checkboxs">
                    ...
                    <span class="people-profile">
                      ...
                      <a href="javascript:void(0);">Summit Peak</a>
                    </span>
                  </label>
                </li>
                <li class="select-people-checkbox">
                  <label class="checkboxs">
                    ...
                    <span class="people-profile">
                      ...
                      <a href="javascript:void(0);">RiverStone Ventur</a>
                    </span>
                  </label>
                </li>
                <li class="select-people-checkbox">
                  <label class="checkboxs">
                    ...
                    <span class="people-profile">
                      ...
                      <a href="javascript:void(0);">Bright Bridge Grp</a>
                    </span>
                  </label>
                </li>
              </ul>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="mb-3">
              ...
              <vue-select :options="ChoosePip" id="choosepip" placeholder="Choose" />
            </div>
          </div>
          <div class="col-md-6">
            <div class="mb-3">
          ...
          <div class="col-md-6">
            <div class="mb-3">
              <label class="col-form-label"
                >Source <span class="text-danger">*</span></label
              >
              <vue-select :options="SocialMedia" id="socialmedia" placeholder="Select" />
            </div>
          </div>
          <div class="col-md-6">
            <div class="mb-3">
...
export default {
  ...
  data() {
    return {
      ...
      DevopsDesign: ["Devops Design", "MargrateDesign", "UI for Chat", "Web Chat"],
      DareleeSelect: [
        "Darlee Robertson",
        "Sharon Roy",
        "Vaughan",
      ...
      CurrencySele: ["Choose", "Dollar", "Euro", "Pound", "Rupee"],
